...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        { icon: <FaTelegramPlane />, url: "https://t.me/itschool_uzb", color: "#0088cc", name: "Telegram" },
    ...
    const contactInfo = [
        {
            ...
            value: "utepovsanjar@gmail.com",
            link: "mailto:utepovsanjar@gmail.com",
            type: "email"
        },
        {
            icon: <Phone size={28} />,
            title: "Telefon",
            value: "+998 91-399-75-04",
            link: "tel:+998913997504",
            type: "phone"
        },
        {
            icon: <MapPin size={28} />,
                ...
                <div className="footer-container">
                    ...
                    <div className="footer-main-row">
                        <div className="footer-info">
                            <p className="footer-description">
                                Utepov.uz - shaxsiy portfolio sayti. Bu yerda tajribalarim va
                    ...
                    <div className="footer-bottom-row">
                        <p className="copyright">
                            &copy; {currentYear} Utepov.uz. Barcha huquqlar himoyalangan.
                        </p>
