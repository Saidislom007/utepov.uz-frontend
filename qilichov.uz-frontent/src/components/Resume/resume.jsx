        ...
        <div className="resume__card">
          ...
          <header className="resume__header">
            <div className="resume__header-content">
              ...
              <div className={`resume-actions ${showDownload ? 'visible' : ''}`}>
                <button onClick={handleDownload} className="action-btn download" title="Yuklab olish">
                  <Download size={20} />
                  <span>Resume yuklab olish</span>
                </button>
              </div>
              <h1 className="resume__name">Qilichov Akobir Kodirovich</h1>
            ...
            <div className="resume__photo-wrapper">
              <div className="resume__photo-frame">
                <img
                  src="/image.png"
                  alt="Qilichov Akobir Kodirovich"
